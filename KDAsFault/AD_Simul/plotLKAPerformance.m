function [max_deviation] = plotLKAPerformance(logsout)
...
lateral_deviation = logsout.getElement('nonbound');    % lateral deviation
max_deviation = max(abs(lateral_deviation.Values.Data(:)));
